...
const projectAPI: ProjectAPI = {
  ...
  searchFilenames: (root: string, query: string, limit?: number, offset?: number) => {
    return ipcRenderer.invoke(IPC.PROJECT_SEARCH_FILENAMES, root, query, limit, offset)
  },
  ...
  patchFileIndex: (root: string, patch: FileIndexPatch) => {
    return ipcRenderer.invoke(IPC.PROJECT_PATCH_FILE_INDEX, root, patch)
  },
