...
SCRIPTS: List[str] = [
    ...
    "test/autotest/run-quick-open-key-latency-autotest.sh",
    ...
    "test/autotest/run-open-browser-autotest.sh",
    ...
    "test/autotest/run-terminal-liveness-hint-autotest.sh",
    "test/autotest/run-git-diff-probe-timeout-autotest.sh",
